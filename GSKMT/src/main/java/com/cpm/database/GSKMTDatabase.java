...
import com.cpm.DailyEntry.CategoryWisePerformance;
...
public class GSKMTDatabase extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "GTMT_DATABASE6";
    public static final int DATABASE_VERSION = 13;
    private SQLiteDatabase db;
    SKUGetterSetter data = new SKUGetterSetter();
    String sku_master;
    TableBean tableBean;
...
//		db.execSQL(TableBean.getCoverage_table());
...
//		db.execSQL(TableBean.getTot_entry_table());
//		db.execSQL(TableBean.getTot_image_table());
    ...
    public void deleteAllTables(String storeid, String process_id) {
        ...
        db.delete(CommonString.TABLE_COVERAGE_DATA, CommonString.KEY_STORE_ID + " = '" + storeid +
                "' AND PROCESS_ID ='" + process_id + "'", null);

        db.delete(CommonString.TABLE_QUESTION_ANSWER, CommonString.KEY_STORE_ID
                + " = '" + storeid + "' AND PROCESS_ID ='" + process_id + "'", null);

        db.delete(CommonString.TABLE_TOT_BEFORE, CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);


        db.delete(CommonString.TABLE_TOT_AFTER, CommonString.KEY_STORE_ID
                + " = '" + storeid + "' AND PROCESS_ID ='" + process_id + "'", null);


        db.delete("DR_STOCK", CommonString.KEY_STORE_ID
                + " = '" + storeid + "' AND PROCESS_ID ='" + process_id + "'", null);

        db.delete("DR_STOCK_IMAGE", CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);

        db.delete(CommonString.TABLE_PROMOTION_DATA, CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);


        db.delete(CommonString.TABLE_SHELF_VISIBILITY, CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);


        db.delete("QUESTION_ANSWER_TABLE_STOCKAFTER", CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);

        db.delete("QUESTION_ANSWER_TABLE", CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);


        db.delete(CommonString.TABLE_AFTERSTOCK_OTHER, CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);


        db.delete(CommonString.TABLE_INSERT_STOCK_TOT, CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);


        db.delete(CommonString.TABLE_INSERT_SALES_STOCK, CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);

        db.delete(CommonString.TABLE_INSERT_ADDTIONAL_DETAILS, CommonString.KEY_STORE_ID
                + " = '" + storeid + "'  AND PROCESS_ID ='" + process_id + "'", null);
    ...
    public void InsertSkuMasterData(SKUGetterSetter data) {
        ...
        try {
            ...
            for (int i = 0; i < data.getSku_id().size(); i++) {
                ...
                values.put("CATEGORY_ID", data
                        .getCategory_id().get(i));

                values.put("CATEGORY", data
    ...
    public void InsertJCP(JCPGetterSetter data) {
        ...
        try {
            ...
            for (int i = 0; i < data.getSTORE_ID().size(); i++) {
                ...
                values.put("STORE", data.getSTORE()
                        .get(i));
                ...
                values.put("PROCESS_ID", data
                        .getPROCESS_ID().get(i));

                values.put("STORETYPE_ID", data
                        .getSTORETYPE_ID().get(i));

                values.put("KEY_ID", data
                        .getKEY_ID().get(i));

                values.put("REGION_ID", data
                        .getREGION_ID().get(i));
    ...
    public void InsertSkuMappingData(StockMappingGetterSetter data) {
        ...
        try {
            ...
            for (int i = 0; i < data.getBrand_id().size(); i++) {
                ...
                values.put("BRAND_SEQUENCE", data.getBrand_sequence().
                        get(i));

                values.put("PROCESS_ID", data.getProcess_id().
                        get(i)
                );

                values.put("REGION_ID", data.getRegion_id().
                        get(i)
                );
    ...
    public void InsertStoreWisePss(StoreWise_Pss data) {
        db.delete("STOREWISE_PSS", null, null);
        ContentValues values = new ContentValues();
        try {
...
//				values.put("VISIT_DATE", data.getVisit_date().get(i));
                ...
                values.put("ADDITIONAL", data.getAdditional().get(i));
                values.put("PSS", data.getPss().get(i));
                values.put("PERIOD", data.getPeriod().get(i));


                db.insert("STOREWISE_PSS", null, values);
        ...
        try {
            ...
            if (dbcursor != null) {
                ...
                while (!dbcursor.isAfterLast()) {
                    ...
                    sb.setPkdKey(dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("PKD_ENABLE")));
                    sb.setSTATE_ID(dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("STATE_ID")));
    ...
    public ArrayList<SkuBean> getCategoryList(String process_id) {
        ...
        try {
            ...
            dbcursor = db.rawQuery("SELECT DISTINCT CATEGORY_ID, CATEGORY from SKU_MASTER"
                            + " where SKU_ID in ( SELECT SKU_ID FROM STOCK_MAPPING WHERE "
    ...
    public ArrayList<SkuBean> gettotBrandList(String category_id, String process_id, String region_id, String store_type_id) {
        Log.d("FetchingStoredata--------------->Start<------------", "------------------");
        ArrayList<SkuBean> list = new ArrayList<SkuBean>();
        Cursor dbcursor = null;
        try {
            dbcursor = db.rawQuery(" SELECT * FROM (SELECT DISTINCT BR.BRAND_ID, BR.BRAND FROM BRAND_MASTER BR INNER JOIN SKU_MASTER SK ON SK.BRAND_ID = BR.BRAND_ID "
                            + " INNER JOIN (SELECT * FROM STOCK_MAPPING WHERE PROCESS_ID = " + process_id + " AND REGION_ID = '" + region_id + "' AND STORETYPE_id ='" +
    ...
    public ArrayList<SkuBean> getSKUList(String category_id, String brand_id, String process_id, String region_id,
        ...
        try {
            dbcursor = db.rawQuery("SELECT * FROM (SELECT SK.SKU_ID, SK.SKU FROM BRAND_MASTER BR INNER JOIN SKU_MASTER SK ON" +
                            ...
                            " INNER JOIN (SELECT * FROM STOCK_MAPPING WHERE PROCESS_ID = '" + process_id + "' AND " +
                            " REGION_ID = '" + region_id + "' AND STORETYPE_id ='" + store_type_id + "')" + " AS M " +
    ...
    public ArrayList<SkuBean> getCompetitionBrandList(String category_id) {
        ...
        try {
            dbcursor = db.rawQuery("SELECT * FROM BRAND_MASTER WHERE COMPANY_ID != 1 AND CATEGORY_ID = '" + category_id + "'",
                    null);
    ...
    public ArrayList<SkuBean> getDisplayListForComp() {
        ...
        try {
            ...
            dbcursor = db.rawQuery("SELECT DISPLAY_ID,DISPLAY FROM DISPLAY_MASTER",
                    null);
    ...
    public ArrayList<SkuBean> getBrandSkuList(String category_id, String store_id, String process_id, String region_id
            , String store_type_id) {
        ...
        try {
            dbcursor = db.rawQuery("SELECT DISTINCT SK.SKU_ID, SK.SKU, SK.BRAND, SK.BRAND_ID, SK.COMPANY_ID from SKU_MASTER SK INNER JOIN STOCK_MAPPING M ON"
                            + " SK.SKU_ID = M.SKU_ID AND SK.CATEGORY_ID = '" + category_id + "' AND M.PROCESS_ID = '" + process_id + "' AND" +
                            " M.REGION_ID = '" + region_id + "' AND M.STORETYPE_ID = '" + store_type_id + "'" + "" +
                            "ORDER BY M.BRAND_SEQUENCE, M.SKU_SEQUENCE" +
                            ""
                    , null);
    ...
    public ArrayList<SkuBean> getBrandSkuListForSales(String category_id, String store_id, String process_id, String region_id
            , String store_type_id) {
        ...
        try {
            dbcursor = db.rawQuery("SELECT DISTINCT SK.SKU_ID, SK.SKU, SK.BRAND, SK.BRAND_ID, SK.COMPANY_ID from SKU_MASTER SK INNER JOIN STOCK_MAPPING M ON"
                            + " SK.SKU_ID = M.SKU_ID AND SK.CATEGORY_ID = '" + category_id + "' AND M.PROCESS_ID = '" + process_id + "' AND" +
                            " M.REGION_ID = '" + region_id + "' AND M.STORETYPE_ID = '" + store_type_id + "'" + " WHERE SK.COMPANY_ID=1 " +
                            "ORDER BY M.BRAND_SEQUENCE, M.SKU_SEQUENCE" +
                            ""
                    , null);
    ...
    public ArrayList<SkuBean> getBrandSkuListBackroom(String category_id, String store_id, String process_id, String region_id
            , String store_type_id) {
        ...
        try {
            ...
            if (dbcursor != null) {
                ...
                while (!dbcursor.isAfterLast()) {
                    ...
                    sb.setPath((dbcursor.getString(dbcursor
...
*/
    ...
    public ArrayList<TOTBean> getInsertedTOTData(String store_id) {
        ...
        try {
            ...
            dbcursor = db.rawQuery("SELECT T.BRAND_ID, B.BRAND, T.DISPLAY_ID, D.DISPLAY, M.TARGET_QTY, " +
                            " T.AFTER_QTY FROM DR_TOT T INNER JOIN BRAND_MASTER B" +
                            " ON B.BRAND_ID = T.BRAND_ID INNER JOIN DISPLAY_MASTER D " +
                            " ON T.DISPLAY_ID = D.DISPLAY_ID INNER JOIN DTS_MAPPING M ON T.STORE_ID = M.STORE_ID AND T.BRAND_ID = M.BRAND_ID AND T.DISPLAY_ID = M.DISPLAY_ID " +
            ...
            if (dbcursor != null) {
                ...
                while (!dbcursor.isAfterLast()) {
                    ...
                    sb.setAFTER_QTY((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("AFTER_QTY"))));
...
//							.getColumnIndexOrThrow("COMPANY_ID"))));
    ...
    public ArrayList<TOTBean> getBeforeTOTData(String store_id, String cate_id, String process_id) {
        ...
        try {
            ...
            dbcursor = db.rawQuery("SELECT * FROM TOT_BEFORE WHERE STORE_ID = '" + store_id + "' " +
                            " AND CATEGORY_ID = '" + cate_id + "' AND PROCESS_ID ='" + process_id + "'"
                    , null);
...
//	fetching stockafter question data
    ...
    public ArrayList<SkuBean> getAfterStockData(String store_id, String cate_id, String process_id) {
        ...
        try {
            ...
            dbcursor = db.rawQuery("SELECT S.SKU_ID , S.AFTER_STOCK_QTY , S.AFTER_FACEUP," +
                            ...
                            " AND S.CATEGORY_ID = '" + cate_id + "' AND S.PROCESS_ID ='" + process_id + "'"
                    , null);
    ...
    public ArrayList<PerformanceBean> getStoreWisePerformanceData(String store_id, String process_id) {
        ...
        try {
            ...
            dbcursor = db.rawQuery("Select * from (select STORE_ID,PERIOD, ROUND(AVG(SOS),0) AS SOS, ROUND(AVG(TOT),0) AS TOT, ROUND(SUM(PSS),0) AS PSS,  ROUND(AVG(PAID),0) AS PAID, ROUND(AVG(ADDITIONAL),0) AS ADDITIONAL FROM STOREWISE_PSS WHERE" +
            ...
            if (dbcursor != null) {
                ...
                while (!dbcursor.isAfterLast()) {
                    ...
                    sb.setPeriod(dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("PERIOD")));

                    sb.setStore_id(dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("STORE_ID")));

                    sb.setSos_avg(dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("SOS")));

                    sb.setTot_avg((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("TOT"))));

                    sb.setPss_avg((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("PSS"))));

                    sb.setPaid_avg((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("PAID"))));


                    sb.setAdditional_avg((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("ADDITIONAL"))));
    ...
    public ArrayList<PerformanceBean> getCategoryWisePerformanceData(String store_id, String process_id, String cat_id) {
        ...
        try {
            ...
            dbcursor = db.rawQuery("Select STORE_ID,PERIOD, SOS , TOT, PSS , PAID, ADDITIONAL FROM STOREWISE_PSS WHERE" +
                            " STORE_ID = '" + store_id + "' AND PROCESS_ID = '" + process_id + "' AND CATEGORY_ID = '" + cat_id + "' GROUP BY STORE_ID,PERIOD"
    ...
    public ArrayList<SkuBean> getAfterStockData2(String store_id, String cate_id, String regionId,
                                                 String store_type_id, String process_id) {
        ...
        try {
            ...
            dbcursor = db.rawQuery("SELECT AFTER_FACEUP FROM DR_STOCK WHERE STORE_ID ='" + store_id + "' AND CATEGORY_ID ='" + cate_id + "' " +
                            " AND PROCESS_ID = ' " + process_id + "'"
                    , null);
            ...
            if (dbcursor != null) {
                ...
                String test = dbcursor.getString(dbcursor
                        .getColumnIndexOrThrow("AFTER_FACEUP"));
                if (test.equalsIgnoreCase("")) {
                    dbcursor = db.rawQuery("SELECT SK.SKU_ID , '' as AFTER_STOCK_QTY , '' as AFTER_FACEUP," +
                            ...
                            " ON M.SKU_ID = SK.SKU_ID INNER JOIN BRAND_MASTER BR ON SK.BRAND_ID = BR.BRAND_ID  WHERE SK.CATEGORY_ID = '" + cate_id + "' AND M.REGION_ID='" + regionId + "'" +
                            " AND M.STORETYPE_ID = '" + store_type_id + "'" + " AND M.PROCESS_ID ='" + process_id + "'"
    ...
    public long InsertCoverage(CoverageBean data, String store_id, String date, String process_id) {
        ...
        long l = 0;
        try {
            db.delete(CommonString.TABLE_COVERAGE_DATA, CommonString.KEY_STORE_ID + "='" + store_id + "' and " + CommonString.KEY_VISIT_DATE
                    + "='" + date + "' AND PROCESS_ID ='" + process_id + "'", null);
    ...
    public long InsertCoverageInLeaveCase(CoverageBean data,
        ...
        try {
            ...
            db.delete(CommonString.TABLE_COVERAGE_DATA,
                    CommonString.KEY_VISIT_DATE
                            + "='" + data.getVisitDate() + "'", null);
            for (int i = 0; i < storelist.size(); i++) {
                ///////////////changed by jeeevannnnnnnnnnnn
...
/*    public static final String CREATE_TABLE_PROMOTION_DATA = "CREATE TABLE "
    ...
    public void InsertTEMPQuestionData(
            ArrayList<TOTBean> data, String display_id, String store_id, String cate_id) {
        ...
        try {
            ...
            for (int i = 0; i < data.size(); i++) {
                ...
                db.insert("TEMP_QUESTION_ANSWER_TABLE", null,
                        values);
            }
...
//						sb.setAnswer("NO");
    ...
    public ArrayList<TOTBean> getStoreWisePssData(String store_id, String display_id, String category_id) {
...
//						sb.setAnswer("NO");
    ...
    public ArrayList<ShelfVisibilityBean> getInsertedShelfData(String store_id, String category_id,
                                                               String process_id, String store_typeid) {
        ...
        try {
            ...
            if (dbcursor != null) {
                ...
                while (!dbcursor.isAfterLast()) {
                    ...
                    sb.setShelf_id((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("SHELF_ID"))));
                    ...
                    sb.setShelf((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("SHELF_NAME"))));
...
//						sb.setAnswer("NO");
    ...
    public ArrayList<ShelfVisibilityBean> getInsertedShelfDataForUpload(String store_id, String process_id) {
        ...
        try {
            ...
            if (dbcursor != null) {
                ...
                while (!dbcursor.isAfterLast()) {
                    ...
                    sb.setStore_typeid((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow(CommonString.KEY_STORE_TYPEID))));

                    sb.setCate_id((dbcursor.getString(dbcursor
                            .getColumnIndexOrThrow("CAT_ID"))));
...
values.put("AFTER_QTY",quantity );*/
    ...
    public void updateShelfData(String storeid, String brand_id, String shelf_id, String process_id,
                                String store_typeid, String yesNO,
                                String image) {

        try {
            ContentValues values = new ContentValues();
            values.put(CommonString.YESNO, yesNO);
            values.put("IMAGE_URL", image);
            db.update(CommonString.TABLE_SHELF_VISIBILITY, values,
                    " STORE_ID ='" + storeid + "' AND  BRAND_ID = '" + brand_id + "' AND SHELF_ID = '" + shelf_id + "'" +
    ...
    public void InsertAdditionalInfo(SkuBean data, String store_id, String cate_id, String process_id) {
        ContentValues values = new ContentValues();
    ...
    public void InsertCompetitionInfo(SkuBean data, String store_id, String cate_id, String process_id) {
        ContentValues values = new ContentValues();
        ...
        try {
            ...
            db.insert(CommonString.TABLE_INSERT_COMPETITION_INFO, null, values);
    ...
    public ArrayList<SkuBean> getEnteredCompetitionDetail(String store_id, String cate_id, String process_id) {
        ...
        try {
            ...
            cursordata = db.rawQuery("SELECT  * from "
                            + CommonString.TABLE_INSERT_COMPETITION_INFO + " where "
                            + CommonString.KEY_STORE_ID + "='" + store_id + "' AND "
                            + CommonString.KEY_CATEGORY_ID + "='" + cate_id + "' AND "
                            + CommonString.KEY_PROCESS_ID + "='" + process_id + "'",
                    null);
    ...
    public ArrayList<SkuBean> getEnteredCompetitionDetailForUploading(String store_id, String process_id) {
        ...
        try {
            ...
            cursordata = db.rawQuery("SELECT  * from "
                            + CommonString.TABLE_INSERT_COMPETITION_INFO + " where "
                            + CommonString.KEY_STORE_ID + "='" + store_id + "' AND PROCESS_ID ='" + process_id + "'"
                    ,
                    null);
    ...
    public ArrayList<SkuBean> getSOSTarget(String store_id, String cate_id, String process_id) {
        ...
        try {
            ...
            cursordata = db.rawQuery("SELECT  * from TARGET_SOS"
                            + " where "
                            + CommonString.KEY_STORE_ID + "='" + store_id + "' AND "
                            + CommonString.KEY_CATEGORY_ID + "='" + cate_id + "' AND "
                            + CommonString.KEY_PROCESS_ID + "='" + process_id + "'",
            ...
            if (cursordata != null) {
                ...
                while (!cursordata.isAfterLast()) {
                    ...
                    sb.setSos_target(cursordata.getString(cursordata
    ...
    public String getSOS(String store_id, String cate_id, String process_id) {
        Cursor cursordata = null;
        ...
        try {
            ...
            if (!cate_id.equalsIgnoreCase("2")) {

                cursordata = db.rawQuery("SELECT CAST(GSK_TOT AS FLOAT)/ CAST(CAT_TOT AS FLOAT)*100 AS SOS FROM" +
                        "(SELECT ST.CATEGORY_ID, SUM(ST.BEFORE_FACEUP) AS CAT_TOT FROM DR_STOCK ST INNER JOIN SKU_MASTER SK" +
                        ...
                        " (SELECT ST.CATEGORY_ID, SUM(ST.BEFORE_FACEUP)AS GSK_TOT FROM DR_STOCK ST INNER JOIN SKU_MASTER SK " +
                        " ON ST.SKU_ID = SK.SKU_ID" +
                        " INNER JOIN BRAND_MASTER BR ON SK.BRAND_ID = BR.BRAND_ID" +
                        " WHERE SK.SKU NOT LIKE '%brush%' AND ST.STORE_ID = '" + store_id + "'" + " AND ST.CATEGORY_ID = '" + cate_id + "' " +
                        "AND ST.PROCESS_ID ='" + process_id + "'" + " AND BR.COMPANY_ID = 1" +
        ...
        try {
            ...
            if (cate_id.equalsIgnoreCase("2")) {
                cursordata = db.rawQuery("SELECT " +
                        ...
                        " AS SOS FROM " + "(SELECT STORE_ID, COUNT(*) AS TARGET FROM SHELF_VISIBILITY " +
                        " WHERE STORE_ID ='" + store_id + "' AND PROCESS_ID ='" + process_id + "' GROUP BY STORE_ID) AS TG" + " INNER JOIN " +
                        "(SELECT STORE_ID, COUNT(*) AS ACTUAL FROM SHELF_VISIBILITY WHERE STORE_ID ='" + store_id + "'" +
    ...
    public ArrayList<StoreBean> getJCP(String date) {
        ...
        try {
            ...
            cursordata = db.rawQuery("SELECT  * from JOURNEY_PLAN WHERE VISIT_DATE = '" + date + "'",
                    null);
            ...
            if (cursordata != null) {
                ...
                while (!cursordata.isAfterLast()) {
                    ...
                    sb.setEMP_ID(cursordata.getString(cursordata
                            .getColumnIndexOrThrow(CommonString.KEY_EMP_CD)));


                    sb.setSTORE(cursordata.getString(cursordata
                            .getColumnIndexOrThrow(CommonString.KEY_STORE)));

                    sb.setREGION_ID(cursordata.getString(cursordata
                            .getColumnIndexOrThrow("REGION_ID")));

                    sb.setStoreType_id(cursordata.getString(cursordata
                            .getColumnIndexOrThrow("STORETYPE_ID")));

                    sb.setUPLOAD_STATUS(cursordata.getString(cursordata
                            .getColumnIndexOrThrow("UPLOAD_STATUS")));
                    ...
                    sb.setVISIT_DATE(cursordata.getString(cursordata
                            .getColumnIndexOrThrow("VISIT_DATE")));

                    sb.setCHECKOUT_STATUS(cursordata.getString(cursordata
                            .getColumnIndexOrThrow("CHECKOUT_STATUS")));

                    sb.setCITY(cursordata.getString(cursordata
                            .getColumnIndexOrThrow("CITY")));
    ...
    public ArrayList<ReasonModel> getNonWorkingReason(String status, boolean upload_status) {
        Cursor cursordata = null;
        ArrayList<ReasonModel> storedata = new ArrayList<ReasonModel>();
        try {
            if (status.equalsIgnoreCase("N") && !upload_status) {
                cursordata = db.rawQuery("SELECT  * from NON_WORKING_REASON", null);
            } else if (!status.equalsIgnoreCase("N") && upload_status) {
                cursordata = db.rawQuery("SELECT  * from NON_WORKING_REASON  WHERE ENTRY_ALLOW='1' AND REASON NOT IN ('Meeting')", null);
            } else {
                cursordata = db.rawQuery("SELECT  * from NON_WORKING_REASON  WHERE ENTRY_ALLOW='1'", null);
            }
            if (cursordata != null) {
                cursordata.moveToFirst();
                while (!cursordata.isAfterLast()) {
    ...
    public ArrayList<PromotionBean> getPromoComplianceData2(String key_id, String process_id, String cate_id, String state_id) {
        ...
        try {
            cursordata = db.rawQuery("SELECT M.ID, M.SKU_ID, M.PROMOTION, SK.SKU from PROMOTION_MAPPING M INNER JOIN " +
                    " SKU_MASTER SK ON M.SKU_ID = SK.SKU_ID WHERE M.KEY_ID = '" + key_id + "' AND M.PROCESS_ID = '" + process_id + "'" +
                    " AND M.CATEGORY_ID = '" + cate_id + "' AND M.STATE_ID = '" + state_id + "'", null);
    ...
    public void SaveShelfData(ArrayList<ShelfVisibilityBean> shelf_list, String process_id, String store_typeid,
        ...
        try {
            ...
            for (int i = 0; i < shelf_list.size(); i++) {
                ...
                values.put(CommonString.SHELF_ID, shelf_list.get(i).getShelf_id());
                ...
                values.put("SHELF_NAME", shelf_list.get(i).getShelf());


                db.insert(CommonString.TABLE_SHELF_VISIBILITY, null, values);
    ...
    public ArrayList<ShelfVisibilityBean> getShelfData(String process_id,
                                                       String region_id, String store_type_id) {
        Log.d("FetchingStoredata--------------->Start<------------",
                "------------------");
        ArrayList<ShelfVisibilityBean> list = new ArrayList<ShelfVisibilityBean>();
        Cursor dbcursor = null;
        try {
            ...
            dbcursor = db.rawQuery("SELECT M.BRAND_ID, BR.BRAND,S.SHELF_ID,S.SHELF FROM MAPPING_WELLNESS_SOS M" +
                    " INNER JOIN BRAND_MASTER BR ON M.BRAND_ID = BR.BRAND_ID" +
                    " INNER JOIN SHELF_MASTER S ON M.SHELF_ID = S.SHELF_ID" +
                    " WHERE M.STORETYPE_ID =' " + store_type_id + "' AND M.REGION_ID ='" + region_id + "'" +
                    " AND M.PROCESS_ID = '" + process_id + "'", null);
...
//					}
    ...
    public ArrayList<PromotionBean> getCompliancePromoData(String process_id) {

        ArrayList<PromotionBean> list = new ArrayList<PromotionBean>();
        Cursor dbcursor = null;
        try {

            dbcursor = db.rawQuery("SELECT * FROM PROMOTION_MAPPING WHERE PROCESS_ID ='" + process_id + "'", null);

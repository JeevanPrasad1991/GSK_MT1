...
public class BeforeStock extends Activity implements OnClickListener {
	...
	ListView lv; Button save; ImageView cam1, cam2, cam3, cam4;
	public static ArrayList<SkuBean> sku_brand_list = new ArrayList<SkuBean>();
	GSKMTDatabase db; String store_id, category_id, process_id, intime, username, app_version, region_id, store_type_id;
	...
	String _Currentdate; boolean  _taken = true;

...
public class StockwareHouse extends Activity implements OnClickListener {
	...
	ListView lv,lv2;
	Button save,save2, shelf_visibility, cancel; ImageView cam1, cam2, cam3, cam4;
	...
	public String image1="", image2="", image3="",_path, date, imgDate, image4="",str;
		...
		db.open();
		 ...
		 if((new File(Environment.getExternalStorageDirectory() + "/MT_GSK_Images/")).exists()){
		  ...
		  if (sku_brand_list.size()==0) {
			  sku_brand_list = db.getBrandSkuListBackroom(category_id, store_id, process_id, region_id,store_type_id);
		} else{
			save.setText("Update");
			update = true;
		}
	 ...
	 private  void showKeyboardWithAnimation() {
			...
			if (mKeyboardView.getVisibility() == View.GONE) {
				Animation animation = AnimationUtils
						.loadAnimation(StockwareHouse.this,
                     ...
                     public void onClick(DialogInterface dialog, int id) {
                    	 ...
                    	 if (update) {
                    		 ...
                    		 for (int i = 0; i < sku_brand_list.size(); i ++){
                 				db.updateBackStoreData(store_id, category_id, process_id, sku_brand_list.get(i).getBackRoomStock(),

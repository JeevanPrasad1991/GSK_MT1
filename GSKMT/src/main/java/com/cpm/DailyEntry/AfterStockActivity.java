    ...
    private class ShelfVisibility extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                //  holder.pdr_facingStock_edt = convertView.findViewById(R.id.pdr_facingStock_edt);
                convertView.setTag(holder);
            } else {
            ...
            holder.cameraShelf.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mposition = position;
                    _pathforcheck1 = store_id + "_" + shelf_list.get(position).getFacing_Target() + "_" + shelf_list.get(position).getBrand_id()
